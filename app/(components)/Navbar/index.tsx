  ...
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="relative">
        <input
          type="search"
          placeholder="search groups and product"
          className="pl-10 pr-4 py-2 w-50 md:w-80 border-2 border-gray-300
         bg-white rounded-lg focus:outline-none focus:border-e-blue-500
         "
        />
        <div
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            justify-center px-[0.4rem] py-1 text-xs font-semibold leading-none text-red-100bg-red-400
           rounded-full "
            >
              5
            </span>
